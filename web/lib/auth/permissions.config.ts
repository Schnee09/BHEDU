...
export const PERMISSIONS: Record<PermissionCode, Permission> = {
  ...
  "students.delete": {
    ...
    name: "Xóa học sinh",
    description: "Xóa hồ sơ học sinh",
    resource: "students",
    action: "delete",
    category: "students",
  },
...
export const ROUTE_CONFIG: RouteConfig[] = [
  ...
  // Timetable
  { path: "/dashboard/timetable", requiredPermissions: ["classes.view"] },
  ...
  {
    path: "/dashboard/grades/transcripts",
    requiredPermissions: ["grades.view"],
  },
  {
    path: "/dashboard/grades/analytics",
    requiredPermissions: ["grades.analytics"],
  },
  ...
  {
    path: "/dashboard/admin/finance/invoices",
    requiredPermissions: ["finance.invoices"],
  },
  {
    path: "/dashboard/admin/finance/payments",
