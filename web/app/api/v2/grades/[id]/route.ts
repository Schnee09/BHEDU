/**
 * Grades API V2 - Resource Detail
 * GET/PATCH/DELETE /api/v2/grades/[id]
 */
...
export async function GET(
    ...
    try {
        ...
        if (!grade) {
            return NextResponse.json({ error: "Grade not found" }, {
                status: 404,
            });
        }
        ...
        console.error("[API] GET /api/v2/grades/[id] error:", error);
...
export async function PATCH(
    ...
    try {
        ...
        console.error("[API] PATCH /api/v2/grades/[id] error:", error);
        return NextResponse.json({ error: "Internal Server Error" }, {
            status: 500,
        });
    }
...
export async function DELETE(
    ...
    try {
        ...
        console.error("[API] DELETE /api/v2/grades/[id] error:", error);
        return NextResponse.json({ error: "Internal Server Error" }, {
            status: 500,
        });
    }
