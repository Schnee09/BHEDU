...
export default function AssignmentManagementPageGuarded() {
  return (
    <PageGuard permissions={['grades.manage', 'grades.entry']} requireAll={false}>
                ...
                <div className="p-6">
                  <div className="flex justify-between items-center mb-6">
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        Total Weight:{' '}
                        <span className={`font-semibold ${getWeightColor()}`}>
                          {getTotalWeight()}%
                        </span>
                        {getTotalWeight() !== 100 && (
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCategoryForm({ ...categoryForm, weight: parseFloat(e.target.value) })
                      }
                      className="w-full px-4 py-2.5 bg-stone-50 dark:bg-stone-800 border border-stone-200 dark:border-stone-700 rounded-2xl focus:outline-none focus:ring-2 focus:ring-amber-500 dark:text-white text-sm"
                      placeholder="VD: 20"
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCategoryForm({ ...categoryForm, drop_lowest: parseInt(e.target.value) })
                      }
                      className="w-full px-4 py-2.5 bg-stone-50 dark:bg-stone-800 border border-stone-200 dark:border-stone-700 rounded-2xl focus:outline-none focus:ring-2 focus:ring-amber-500 dark:text-white text-sm"
                    />
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setAssignmentForm({ ...assignmentForm, category_id: e.target.value })
                      }
                      className="w-full px-4 py-2.5 bg-stone-50 dark:bg-stone-800 border border-stone-200 dark:border-stone-700 rounded-2xl focus:outline-none focus:ring-2 focus:ring-amber-500 dark:text-white text-sm"
                    >
                  ...
                  <div className="flex items-center pt-2">
                    <input
                      ...
                      onChange={(e) =>
                        setAssignmentForm({ ...assignmentForm, published: e.target.checked })
                      }
                      className="h-4 w-4 text-amber-500 focus:ring-amber-500 border-stone-300 rounded"
                    />
                    <label
                      htmlFor="published"
                      className="ml-2 block text-xs font-bold text-stone-700 dark:text-stone-300"
                    >
