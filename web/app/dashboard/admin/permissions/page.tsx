            ...
            {!selectedUser ? (
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 pb-4 border-b border-border">
                  ...
                  <div className="flex-1 min-w-0">
                    <h2 className="text-xl font-semibold">{userPermData.user.full_name}</h2>
                ...
                {(userPermData.user.role === 'admin' ||
                  userPermData.user.role === 'super_admin') && (
  ...
  return (
    <div className="border border-border rounded-lg overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs text-muted-foreground">{permissions.length} quyền</span>
