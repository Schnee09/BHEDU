      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-2">
          ...
          <p className="text-sm text-stone-500 max-w-2xl">
            Giao diện lưới Excel trực quan. Đánh dấu học sinh đã nộp học phí hàng tháng bằng cách
            click checkbox.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <Button
            ...
            className={`rounded-xl text-xs font-bold flex items-center gap-2 transition-all ${
              hasChanges
            ...
            <table className="min-w-full border-collapse border border-stone-200 dark:border-white/5 rounded-sharp">
              <thead>
                <tr className="bg-stone-50 dark:bg-stone-900/50 text-left text-xs font-bold text-stone-600 dark:text-stone-400 uppercase tracking-wider">
                  <th className="border border-stone-200 dark:border-white/5 px-6 py-4">
                    Họ và tên
                  </th>
