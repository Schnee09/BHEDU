...
async function fetchStudentWithClient(supabase: any, id: string) {
  ...
  if (pErr)
    return { profile: null, enrollments: [], attendance: [], grades: [], error: pErr.message };
...
export default async function AdminStudentDetail({ params }: { params: Promise<{ id: string }> }) {
  ...
  const showFinance = hasAdminAccess || user?.id === id;
        ...
        <div className="flex items-center justify-between flex-wrap gap-6 border-b border-stone-200 dark:border-stone-800 pb-8">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-6 flex-wrap">
              ...
              <Badge
                color="blue"
                className="px-5 py-1.5 rounded-sharp uppercase tracking-widest text-[10px] font-bold"
              >
                Học sinh
              </Badge>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="lg:col-span-2">
              <Card
                padding="lg"
                className="glass-crystal rounded-sharp border-none shadow-2xl relative overflow-hidden group"
              >
                <div className="flex flex-col md:flex-row items-start justify-between gap-12">
                  <div className="space-y-6 flex-1">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-1 bg-red-600" />
                      <h2 className="text-xl font-bold uppercase tracking-widest text-stone-500">
                        Thông tin cá nhân
                      </h2>
                    </div>
            ...
            <Card
              padding="lg"
              className="glass-crystal rounded-sharp border-none hover:bg-white/5 transition-colors border-l-4 border-l-lime-500"
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[10px] text-lime-500 font-bold uppercase tracking-widest mt-2">
                    Đang theo học
                  </p>
                </div>
            ...
            <Card
              padding="lg"
              className="glass-crystal rounded-sharp border-none hover:bg-white/5 transition-colors border-l-4 border-l-red-600"
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[10px] font-bold text-stone-500 uppercase tracking-widest">
                  ...
                  <p className="text-[10px] text-red-600 font-bold uppercase tracking-widest mt-2">
                    Bản ghi gần nhất
                  </p>
                </div>
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <Card
              padding="lg"
              className="glass-crystal rounded-sharp border-none hover:bg-white/5 transition-colors border-l-4 border-l-gold-accent"
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[10px] font-bold text-stone-500 uppercase tracking-widest">
                  ...
                  <p className="text-[10px] text-gold-accent font-bold uppercase tracking-widest mt-2">
                    Bài kiểm tra
                  </p>
                </div>
            ...
            tabs={[
              {
                key: 'enrollments',
                label: 'Lớp học',
                content: <EnrollmentManager studentId={id} />,
              },
              {
                key: 'guardians',
                label: 'Người giám hộ',
                content: <GuardianManagement studentId={id} />,
              },
              {
                key: 'attendance',
                label: 'Điểm danh',
                  ...
                  <Card padding="lg" className="glass-crystal rounded-sharp border-none shadow-2xl">
                    {attendance.length === 0 ? (
                      <Empty
                        ...
                        description="Học sinh này chưa có bản ghi điểm danh nào."
                      />
                    ) : (
                              ...
                              <tr key={a.id} className="hover:bg-white/5 transition-colors">
                                ...
                                <td className="px-6 py-4">
                                  <Badge
                                    ...
                                    className="rounded-sharp uppercase text-[9px] font-bold px-3"
                                  >
                                    {a.status === 'present'
                                      ? 'Có mặt'
                                      : a.status === 'absent'
                ...
                ? [
                    {
                      ...
                      content: (
                        <Card
                          padding="lg"
                          className="glass-crystal rounded-sharp border-none shadow-2xl"
                        >
                          {account ? (
                            <div className="mb-10 grid grid-cols-1 md:grid-cols-3 gap-8">
                              <div className="p-8 glass-crystal rounded-sharp border-l-4 border-l-stone-500">
                                <p className="text-[10px] font-bold text-stone-500 uppercase tracking-widest mb-2 text-center">
                                  Trạng thái tài khoản
                                </p>
                                <p className="text-2xl font-bold text-center uppercase tracking-tight">
                                  {accountInfo?.status ?? '—'}
                                </p>
                              </div>
                              <div className="p-8 glass-crystal rounded-sharp border-l-4 border-l-red-600">
                                ...
                                <p className="text-3xl font-bold text-center text-red-600 tracking-tight">
                                  ₫
                                  {accountInfo?.balance
                              ...
                              <div className="p-8 glass-crystal rounded-sharp border-l-4 border-l-gold-accent text-center">
                                ...
                                <p className="text-sm font-bold mt-2 uppercase">
                                  {accountInfo?.last_payment_date
                                    ? new Date(accountInfo.last_payment_date).toLocaleDateString(
                                        'vi-VN'
                                      )
                                    : 'Chưa có giao dịch'}
                                </p>
                            ...
                            <Empty
                              ...
                              description="Tài khoản học phí cho học sinh này chưa được khởi tạo."
                            />
                          )}

                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            <div className="space-y-6">
                              <h3 className="font-bold text-stone-500 uppercase tracking-widest text-[11px] px-6">
                                Hóa đơn gần đây
                              </h3>
                                        ...
                                        >
                                          ...
                                          <td className="px-6 py-4">
                                            <Badge
                                              ...
                                              className="rounded-sharp uppercase text-[8px] font-bold"
                                            >
                                              {inv.status}
                                            </Badge>
                                          </td>
                                          <td className="px-6 py-4 font-bold text-red-600">
                                            ₫{Number(inv.balance).toLocaleString('vi-VN')}
                                          </td>
                                          <td className="px-6 py-4 text-stone-500 text-[10px] font-bold">
                                            {inv.due_date
                                    ...
                                    <tbody className="divide-y divide-stone-100 dark:divide-stone-800">
                                      {paymentsList.map((p: any) => (
                                        ...
                                        >
                                          ...
                                          <td className="px-6 py-4 font-bold text-lime-500">
                          ...
                          {auditsList.length === 0 ? (
                            ...
                            <ul className="space-y-6">
                              {auditsList.map((a: any) => (
                                <li
                                  key={a.id}
                                  className="flex items-start gap-6 p-6 rounded-sharp bg-white/5 hover:bg-white/10 transition-all"
                                >
                                  ...
                                  <div className="flex-1 space-y-2">
                                    ...
                                    <p className="text-[10px] text-stone-600 uppercase tracking-widest">
                                      Mã định danh tác nhân: {a.actor_id}
                                    </p>
                                  </div>
                                </li>
                              ))}
