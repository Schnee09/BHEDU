        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-8 relative z-10">
          ...
          <div className="flex items-center gap-4 bg-stone-50 dark:bg-white/5 p-6 rounded-3xl border border-stone-100 dark:border-white/5">
            ...
            <div>
              ...
              <p className="font-serif font-black text-stone-900 dark:text-white uppercase leading-none">
                50 Hồ sơ / lượt
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between mb-8 relative z-10">
            <div>
              ...
              <p className="text-[10px] font-black text-stone-400 uppercase tracking-widest mt-1">
                Dữ liệu tài khoản vừa khởi tạo
              </p>
            </div>
            {results.length > 0 && (
              <button
          ...
          <div className="flex-1 min-h-[400px] relative z-10">
            {results.length === 0 && errors.length === 0 ? (
              <div className="absolute inset-0 flex flex-col items-center justify-center text-stone-300 dark:text-stone-700">
                ...
                <p className="font-serif italic text-lg decoration-amber-500/30">
                  Dữ liệu sẽ hiển thị tại đây sau khi xử lý
                </p>
              </div>
            ) : (
                  ...
                  <div className="bg-white dark:bg-stone-900 rounded-[2rem] shadow-xl overflow-hidden border border-rose-500/20">
                    ...
                    <div className="p-4">
                      {errors.map((e, i) => (
                        <div
                          key={i}
                          className="flex items-center gap-4 p-3 hover:bg-rose-50 dark:hover:bg-rose-500/5 rounded-xl transition-colors"
                        >
                          <Badge variant="danger" className="font-black text-[9px] h-5 px-2">
                            LỖI
                          </Badge>
                          <span className="font-serif font-black text-stone-800 dark:text-white uppercase text-xs">
                            {e.full_name || 'Không xác định'}
                          </span>
                          <span className="text-stone-500 dark:text-stone-400 text-xs italic opacity-80">
                            — {e.error}
                          </span>
                        </div>
                      ))}
