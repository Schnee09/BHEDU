      ...
      {!importComplete ? (
        <>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <h2 className="font-semibold mb-2">踏 Step 1: Download Template</h2>
          ...
          <div className="bg-white border border-gray-300 rounded-lg p-6 mb-6">
            <h2 className="font-semibold mb-4">豆 Step 2: Upload Your CSV File</h2>
          ...
          {preview && (
            <div className="bg-white border border-gray-300 rounded-lg p-6 mb-6">
              <h2 className="font-semibold mb-4">笨・Step 3: Review and Import</h2>
              ...
              {preview.errors.length > 0 && (
                <div className="mb-6">
                  <h3 className="font-semibold text-red-600 mb-2">笶・Errors (must fix):</h3>
              ...
              {preview.warnings.length > 0 && (
                <div className="mb-6">
                  <h3 className="font-semibold text-yellow-600 mb-2">笞・・Warnings (optional fixes):</h3>
        ...
        <div className="bg-white border border-gray-300 rounded-lg p-6">
          <h2 className="text-2xl font-bold mb-4 text-green-600">脂 Import Complete!</h2>
