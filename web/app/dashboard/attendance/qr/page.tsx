      ...
      {generatedQRs.length === 0 ? (
        ...
        <>
          <div className="bg-white border border-gray-300 rounded-lg p-6 mb-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <h3 className="font-semibold text-blue-900 mb-2">邃ｹ・・How it works:</h3>
        ...
        <div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <h2 className="font-semibold text-lg mb-1">
                  笨・Generated {generatedQRs.length} QR Codes
                </h2>
                <p className="text-sm text-gray-600">
                  Valid for {date} 窶｢ Expires in {expiryHours} hours
                </p>
              </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6 print:hidden">
            <h3 className="font-semibold text-yellow-900 mb-2">搭 Instructions for Students:</h3>
