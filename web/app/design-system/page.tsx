    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 py-12 px-4">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl font-bold bg-gradient-to-br from-blue-600 to-slate-700 bg-clip-text text-transparent font-heading mb-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-9 gap-3">
                {[50, 100, 200, 300, 400, 500, 600, 700, 800].map((shade) => (
                  <div key={shade} className="flex flex-col items-center">
                    <div
                      className={`w-16 h-16 rounded-lg shadow-md bg-blue-${shade} border border-slate-200`}
                    />
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-9 gap-3">
                {[50, 100, 200, 300, 400, 500, 600, 700, 800].map((shade) => (
                  <div key={shade} className="flex flex-col items-center">
                    <div
                      className={`w-16 h-16 rounded-lg shadow-md bg-slate-${shade} border border-slate-200`}
                    />
                    <span className="text-xs text-slate-600 mt-2">{shade}</span>
                  </div>
                ))}
        ...
        <Card className="p-8">
          ...
          <div className="space-y-4">
            ...
            <h4 className="text-xl font-heading font-semibold text-slate-900">
              Heading 4 - Poppins Semibold
            </h4>
            <p className="text-base text-slate-700">
              Body text - Open Sans Regular. Lorem ipsum dolor sit amet, consectetur adipiscing
              elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
            <p className="text-sm text-slate-600">
              Small text - Open Sans Regular. Used for captions and secondary information.
            </p>
          </div>
        </Card>
        ...
        <Card className="p-8">
          ...
          <div className="max-w-2xl space-y-5">
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-2">Email Input</label>
              <input
                type="email"
                className="w-full border-2 border-slate-200 px-4 py-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all bg-white text-slate-900 placeholder-slate-400"
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <span className="px-4 py-2 rounded-full text-sm font-semibold bg-gradient-to-br from-amber-500 to-amber-700 text-white shadow-sm">
                  Student
                </span>
              </div>
            </div>
        ...
        <div className="text-center py-8">
          <p className="text-slate-600">BH-EDU Design System v2.0 • Professional Blue Theme</p>
          <p className="text-sm text-slate-500 mt-2">Optimized for admin staff and teachers</p>
        </div>
      </div>
