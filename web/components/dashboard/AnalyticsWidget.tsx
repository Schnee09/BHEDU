      ...
      case 'line':
        return (
          <ResponsiveContainer
            ...
            minWidth={0}
            minHeight={height}
            initialDimension={{ width: 500, height: typeof height === 'number' ? height : 300 }}
          >
            <LazyLineChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
              ...
              <XAxis dataKey={xAxisKey} stroke="var(--text-muted)" fontSize={12} tickLine={false} />
        ...
        return (
          ...
          >
            <LazyRadarChart data={data} cx="50%" cy="50%" outerRadius="80%">
              ...
              <PolarAngleAxis dataKey={xAxisKey} stroke="var(--text-muted)" fontSize={12} />
      ...
      <div className="p-4 md:p-5 lg:p-6">
        <div className="flex items-center justify-between mb-4 md:mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-black text-lg md:text-xl text-stone-900 dark:text-white uppercase tracking-tight">
                {title}
              </h3>
              {subtitle && (
                <p className="text-xs font-bold text-stone-400 dark:text-stone-500 uppercase tracking-widest mt-0.5 md:mt-1">
                  {subtitle}
                </p>
              )}
            </div>
