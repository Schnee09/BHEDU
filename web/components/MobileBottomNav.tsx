    ...
    <div className="lg:hidden">
      ...
      >
        <div className="glass-premium rounded-t-[40px] rounded-b-[20px] shadow-2xl pb-safe overflow-hidden border border-white/20 dark:border-white/5 relative">
          ...
          <h3 className="text-[11px] font-black text-center text-stone-400 dark:text-stone-500 uppercase tracking-[0.4em] mb-10 mt-4 leading-none">
            Trung tâm dịch vụ
          </h3>
          ...
          {mainNavItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {active && (
                  <div
                    className="absolute top-2 w-1 h-1 rounded-full bg-amber-500 shadow-[0_0_10px_rgba(245,166,35,0.8)]"
                    style={{
