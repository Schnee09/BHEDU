        ...
        bg-stone-100/40 dark:bg-white/5 border border-transparent hover:border-amber-500/50 hover:bg-white hover:shadow-lg hover:shadow-amber-500/10 hover:scale-105"
            >
                <div className="relative p-0.5">
                    ...
                    <div className="w-8 h-8 md:w-8 md:h-8 rounded-xl flex items-center justify-center text-white font-bold text-xs md:text-sm relative z-10 shadow-sm overflow-hidden"
            ...
            {isOpen && (
                <>
                    ...
                    <div className="absolute top-24 right-4 md:right-0 w-72 py-3 z-[110] overflow-hidden rounded-[24px] animate-scale-in origin-top-right
          bg-white dark:bg-[#1C1A16] border border-stone-200 dark:border-white/10 shadow-[0_32px_64px_-12px_rgba(0,0,0,0.5)]">
                        <div className="px-6 py-5 border-b border-stone-100 dark:border-white/5 bg-stone-50/50 dark:bg-white/5">
                            <p className="font-bold text-stone-900 dark:text-white tracking-tight">{profile?.full_name || "Hồ sơ"}</p>
