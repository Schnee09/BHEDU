...
export function QuickActions({
    ...
    return (
        <div className="relative">
            ...
            >
                <PlusIcon className={cn("w-5 h-5 transition-transform duration-300 text-stone-500 group-hover:text-amber-500", isOpen && "rotate-45 text-white")} strokeWidth={2.5} />
            </button>
                ...
                <>
                    ...
                    <div className={cn(
                        ...
                        <div className="px-5 py-4 md:py-3 border-b border-stone-100 dark:border-white/5 bg-stone-50/50 dark:bg-white/5 md:mb-2">
                            <p className="font-black text-xs text-stone-500 dark:text-stone-400 uppercase tracking-widest text-center md:text-left">Thao tác nhanh</p>
                        </div>
