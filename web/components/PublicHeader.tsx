      ...
      <div className="container flex h-20 items-center justify-between px-4 md:px-6">
        ...
        <Link href="/" className="flex items-center gap-4 group">
          ...
          <div className="flex flex-col leading-none">
            ...
            <span className="font-black text-2xl bg-gradient-to-r from-amber-500 via-amber-600 to-orange-500 bg-clip-text text-transparent tracking-tight">
              HOÀNG
            </span>
            <span className="text-[9px] text-amber-600/80 dark:text-amber-400/80 font-bold tracking-[0.25em] uppercase mt-1">
              Education
            </span>
          </div>
        </Link>
