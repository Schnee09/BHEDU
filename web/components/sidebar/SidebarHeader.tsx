        ...
        <div className="flex flex-col border-b border-stone-100 dark:border-white/5 pb-6 relative overflow-hidden">
                ...
                {!isCollapsed ? (
                    <>
                        <Link href="/dashboard" className="flex items-center gap-2 group">
                            ...
                            <span className="text-[9px] font-black text-stone-400 group-hover:text-stone-600 dark:group-hover:text-stone-300 transition-colors uppercase tracking-[0.25em]">BH-EDU LIVE</span>
                        </Link>

                        <div className="px-2.5 py-1 bg-amber-500/10 rounded-lg border border-amber-500/20 shadow-sm backdrop-blur-sm">
                            <span className="text-[9px] font-black text-amber-600 dark:text-amber-400 uppercase tracking-widest leading-none">HKII-2025</span>
                        </div>
                    </>
                ) : (
            ...
            <div className={cn(
                ...
                <div className={cn(
                    ...
                    <div className="flex items-center justify-center w-full h-full text-amber-500 font-serif font-black text-2xl italic tracking-tighter drop-shadow-sm">BH</div>
                </div>
