console.log('Please run the following SQL in your Supabase SQL Editor to fix the infinite recursion issue:');
console.log('');
console.log(`-- Fix infinite recursion in RLS policies
-- Run this in Supabase SQL Editor: https://mwncwhkdimnjovxzhtjm.supabase.co/project/_/sql
