------------------------------------------------------------
-- 🏫 COMPLETE TEST SEED SCRIPT
-- For: Supabase Dashboard or CLI
-- Date: 2025-11-21
-- This file seeds all reference data for proper testing
------------------------------------------------------------
...
VALUES (
  ...
  '[{"letter": "A+", "min": 97, "max": 100, "gpa": 4.0, "description": "Outstanding"}, {"letter": "A",  "min": 93, "max": 96,  "gpa": 4.0, "description": "Excellent"}, {"letter": "A-", "min": 90, "max": 92,  "gpa": 3.7, "description": "Very Good"}, {"letter": "B+", "min": 87, "max": 89,  "gpa": 3.3, "description": "Good"}, {"letter": "B",  "min": 83, "max": 86,  "gpa": 3.0, "description": "Above Average"}, {"letter": "B-", "min": 80, "max": 82,  "gpa": 2.7, "description": "Average"}, {"letter": "C+", "min": 77, "max": 79,  "gpa": 2.3, "description": "Satisfactory"}, {"letter": "C",  "min": 73, "max": 76,  "gpa": 2.0, "description": "Below Average"}, {"letter": "C-", "min": 70, "max": 72,  "gpa": 1.7, "description": "Poor"}, {"letter": "D",  "min": 60, "max": 69,  "gpa": 1.0, "description": "Failing"}, {"letter": "F",  "min": 0,  "max": 59,  "gpa": 0.0, "description": "Fail"}]'::jsonb,
  true,
  NOW()
),
(
  ...
  '[{"letter": "100", "min": 100, "max": 100, "gpa": 4.0, "description": "Perfect"}, {"letter": "90+", "min": 90, "max": 99, "gpa": 3.7, "description": "Excellent"}, {"letter": "80+", "min": 80, "max": 89, "gpa": 3.0, "description": "Good"}, {"letter": "70+", "min": 70, "max": 79, "gpa": 2.0, "description": "Satisfactory"}, {"letter": "60+", "min": 60, "max": 69, "gpa": 1.0, "description": "Pass"}, {"letter": "<60", "min": 0,  "max": 59, "gpa": 0.0, "description": "Fail"}]'::jsonb,
  false,
  NOW()
)
ON CONFLICT (id) DO UPDATE SET
